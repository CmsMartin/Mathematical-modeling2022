...
对于上面提到的第一种方案，我们可以证明一定存在一个最优解，使核酸检测点在一个点上。于是我们可以直接枚举核酸检测点在哪个点上，并选择使路程和最小的点，从而构造出一种最优解。
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\textwidth,height=0.4\textwidth]{images/mdst-plot1.png}
